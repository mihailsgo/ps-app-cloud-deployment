...
| Keycloak errors / login broken after deploy, even though the browser's certificate looks fine | [20.1 Common Issues](20-01-common-issues.md), issue 7 |
| All Keycloak admin credentials fail, totally locked out | [14.7 Break-glass admin recovery](14-07-break-glass-admin-recovery.md) |
| Services can't reach each other (e.g. ps-server → DMSS) | [20.1 Common Issues](20-01-common-issues.md), issue 6 |
| Signing fails with a permissions error writing to `docs/`, even after bootstrap/upgrade ran | [20.1 Common Issues](20-01-common-issues.md), issue 8 |
